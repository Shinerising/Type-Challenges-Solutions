...
// ============= Your Code Here =============
type AssignObject<T extends object, U extends object> = {
  [K in keyof T | keyof U]: K extends keyof U ? U[K] : K extends keyof T ? T[K] : never
}
type Assign<T extends object, U extends unknown[]> =
  U extends [infer A extends object, ...infer B extends object[]] ?
  Assign<AssignObject<T, A>, B> :
  T